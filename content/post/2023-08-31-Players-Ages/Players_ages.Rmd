...
ages_histogram <- data %>% 
  ...
  geom_vline(xintercept = mean_age,linetype="dashed",colour="lightblue")+
  geom_vline(xintercept = median_age,linetype="dashed", colour="#800020")+
  geom_text(aes(x=60,y=60,label=str_c("Median Player Age = ",round(median_age,2 ))),colour="#800020")+
  geom_text(aes(x=60,y=55,label=str_c("Mean Player Age = ", round(mean_age,2))),colour="lightblue")
...
mean_ages_graph <- a + 
  ...
  geom_hline(yintercept = median_age,size=0.5,colour="#800020")+
  geom_text(x=18,y=80,label="Median player age = 27 years",colour="#800020")+
...
- The "right skew" in the histogram above is evident most seasons: 
    + The majority of houseguests are clustered in their 20's with 2-3 players > 35 years each season. 
...
#### The slope of the red line is not singificantly different than 0, indicating that although few older players have won, they do not get evicted earlier than younger players. 
